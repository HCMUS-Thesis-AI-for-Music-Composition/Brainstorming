...
inst_class_id_to_inst_class_name = {
        ...
        # keyboard 1:
        1: ['đàn phím', "đàn phím điện tử", "đàn phím synthesizer"],
        ...
        # trumpet 12:
        12: ['trumpet (một loại kèn thuộc bộ đồng)'],

        # trombone 13:
        13: ['trombone (một loại kèn thuộc đồng)'],

        # tuba 14:
        14: ['tuba (một loại kèn thuộc bộ đồng)'],

        # horn 15:
        15: ['horn (một loại kèn thuộc bộ đồng)'],

        # brass 16:
        16: ['kèn đồng'],

        # sax 17:
        17: ['saxophone (một loại kèn bộ thuộc bộ gỗ)', "saxophone"],

        # oboe 18:
        18: ['oboe (một loại kèn thuộc bộ gỗ)'],

        # bassoon 19:
        19: ['bassoon (một loại kèn thuộc bộ gỗ)'],

        # clarinet 20:
        20: ['clarinet (một loại kèn thuộc bộ gỗ)'],

        # piccolo 21:
        21: ['piccolo (một loại kèn thuộc bộ gỗ)'],

        # flute 22:
        22: ['sáo'],

        # pipe 23:
        23: ['kèn ống (một loại kèn thuộc bộ gỗ)'],
